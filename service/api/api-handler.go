...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.PUT("/chats/:chat_id/messages/:message_id/reactions/:reaction_id", rt.commentMessage)   // ok
	rt.router.DELETE("/chats/:chat_id/messages/:message_id/reactions/:reaction_id", rt.deleteComment) // ok
