...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.GET("/users/:user_id/photo", rt.getProfilePhoto) // ok
	// SEARCH
	...
	rt.router.PUT("/chats/:chat_id/photo", rt.putNewGroupPhoto)          // ok
	rt.router.GET("/chats/:chat_id/photo", rt.getGroupPhoto)			 // ok
	...
	// MESSAGE
	rt.router.PUT("/chats/:chat_id/messages/:message_id/status", rt.updateStatus)                    // ok 
	...
	// MEDIA
	rt.router.POST("/chats/:chat_id/media", rt.sendMedia)     // ok
	rt.router.GET("/chats/:chat_id/media/:media_id", rt.getMedia) // ok
	rt.router.DELETE("/chats/:chat_id/media/:media_id", rt.deleteMedia) // ok
	// LOGIN
